...
<body>
    <div id="home">
        ...
        <div id="contacts" >
         ...
         <div id="content_main">
            <h5 id="form_label">اضافة للمخزن</h5>
            <form  action="database/inventoryDB.php" method="post" class="appForm">
              <div class="appFormInputContainer">
                    <label for="pro_name">اسم المنتج </label>
                    <input class="appFormInput" type="text" name="pro_name" id="pro_name" placeholder="اسم المنتج">
                </div>
                <div class="appFormInputContainer">
                    <label for="barcode">الباركود</label>
                    <input class="appFormInput" type="text" name="barcode" id="barecode" placeholder="الباركود" required>
                </div>
                <div class="appFormInputContainer">
                    <label for="quantity">الكميه</label>
                    <input class="appFormInput" type="number" min="1" name="quantity" id="quantity" placeholder="الكميه" required>
                </div>
                <div class="appFormInputContainer">
                    <label for="supplier_name">اسم المورد</label>
                    <input class="appFormInput" type="text"  name="supplier_name" id="supplier_name" placeholder="اسم المورد">
                </div>
                
                <button type="submit" id="formButton"><i class='bx bx-plus'></i>اضافة</button>
         ...
         <button id="showSuppliersBtn" onclick="window.location.href='show_inventory_product.php';">Show inventory</button>
